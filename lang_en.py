strings = {
	...
	'prototype_malice': 'Prototype Amber',
	...
	'prototype_aminus': 'Prototype Archaic',
	...
	'prototype_grudge': 'Prototype Starglitter',
	...
	'berserker_bonus': ["CRIT Rate +12%", "When HP is below 70%, CRIT Rate increases by an additional 24%"],
	'bloodstained_chivalry_bonus': ["Physical DMG +25%", "After defeating an opponent, increases Charged Attack DMG by 50%, and reduces its Stamina cost to 0 for 10s."],
	'brave_heart_bonus': ["ATK +18%", "Increases DMG by 30% against enemies with more than 50% HP"],
	'crimson_witch_of_flames_bonus': ["Pyro DMG Bonus +15%", "Increases Overloaded and Burning DMG by 40%. Increases Vaporize and Melt DMG by 15%. Using an Elemental Skill increases 2-Piece Set effects by 50% for 10s. Max 3 stacks."],
	'defenders_will_bonus': ["DEF +30%", "For each different element present in your own party, the wearer's Elemental RES to that corresponding element is increased by 30%"],
	'gambler_bonus': ["Elemental Skill DMG increased by 20%", "Defeating an enemy has 100% chance to remove Elemental Skill CD. Can only occur once every 15s."],
	'gladiators_finale_bonus': ["ATK +18%", "If the wielder of this artifact set uses a Sword, Claymore or Polearm, increases their Normal Attack DMG by 35%"],
	'instructor_bonus': ["Increases Elemental Mastery by 80", "Upon triggering an Elemental Reaction, increases all party members' Elemental Mastery by 120 for 8s"],
	'lavawalker_bonus': ["Pyro RES increased by 40%", "Increases DMG against enemies that are Burning or affected by Pyro by 35%"],
	'lucky_dog_bonus': ["DEF increased by 100", "Picking up Mora restores 300 HP"],
	'maiden_beloved_bonus': ["Character Healing Effectiveness +15%", "Using an Elemental Skill or Burst increases healing received by all party members by 20% for 10s"],
	'martial_artist_bonus': ["Increases Normal Attack and Charged Attack DMG by 15%", "After using Elemental Skill, increases Normal Attack and Charged Attack DMG by 25% for 8s"],
	'noblesse_oblige_bonus': ["Elemental Burst DMG +20%", "Using an Elemental Burst increases all party members' ATK by 20% for 12s. This effect cannot stack."],
	'prayers_for_destiny_bonus': ["Affected by Hydro for 40% less time"],
	'prayers_for_illumination_bonus': ["Affected by Pyro for 40% less time"],
	'prayers_for_wisdom_bonus': ["Affected by Electro for 40% less time"],
	'prayers_to_springtime_bonus': ["Affected by Cryo for 40% less time"],
	'resolution_of_sojourner_bonus': ["ATK +18%", "Increases Charged Attack CRIT Rate by 30%"],
	'retracing_bolide_bonus': ["Increases the effectiveness of shields by 35%", "Gain an additional 40% Normal and Charged Attack DMG while under the protection of a shield"],
	'scholar_bonus': ["Energy Recharge +20%", "Gaining Energy gives 3 Energy to all party members who have a bow or a catalyst equipped. Can only occur once every 3s."],
	'the_exile_bonus': ["Energy Recharge +20%", "Using an Elemental Burst regenerates 2 Energy for all party members (excluding the wearer) every 2s for 6s. This effect cannot stack."],
	'thundering_fury_bonus': ["Electro DMG Bonus +15%", "Increases damage caused by Overloaded, Electro-Charged, and Superconduct DMG by 40%. Triggering such effects decreases Elemental Skill CD by 1s. Can only occur once every 0.8s."],
	'thundersoother_bonus': ["Electro RES increased by 40%", "Increases DMG against enemies affected by Electro by 35%"],
	'tiny_miracle_bonus': ["All Elemental RES increased by 20%", "Incoming elemental DMG increases corresponding Elemental RES by 30% for 10s. Can only occur once every 10s."],
	'traveling_doctor_bonus': ["Increases incoming healing by 20%", "Using Elemental Burst restores 20% HP"],
	'viridescent_venerer_bonus': ["Anemo DMG Bonus +15%", "Increases Swirl DMG by 60%. Decreases opponent's Elemental RES to the element infused in the Swirl by 40% for 10s."],
	'wanderers_troupe_bonus': ["Elemental Mastery +80", "Increases Charged Attack DMG by 35% if the character uses a Catalyst or Bow"],
	'blizzard_strayer_bonus': ["Cryo DMG Bonus +15%", "When a character attacks an enemy affected by Cryo, their CRIT Rate is increased by 20%. If the enemy is Frozen, CRIT Rate is increased by an additional 20%."],
	'heart_of_depth_bonus': ["Hydro DMG Bonus +15%", "After using Elemental Skill, increases Normal Attack and Charged Attack DMG by 30% for 15s."],
	# Days of the Week
	'any': 'Any Day',
	'mon': 'Monday',
	'tue': 'Tuesday',
	...
	'special_inazuma': "Found around Inazuma",
	'event': 'Event item',
